...
const HEADER_ALIASES: Record<string, keyof Omit<ColumnMap, "headerRowIndex">> = {
  ...
  credit: "credit",
  name: "name",
  // The reference/document number. On a bank statement this is the CHEQUE
  // number — recognise both spellings so either header maps to the same field.
  "voucher no": "voucherNo",
  "voucher no.": "voucherNo",
  "voucher number": "voucherNo",
  "cheque no": "voucherNo",
  "cheque no.": "voucherNo",
  "cheque number": "voucherNo",
  "cheque": "voucherNo",
  "chq no": "voucherNo",
  "chq no.": "voucherNo",
  "check no": "voucherNo",
  "check number": "voucherNo",
  "bank fee": "bankFee",
  "bank fees": "bankFee",
  balance: "balance",
};
