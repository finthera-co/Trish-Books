...
const DEFAULT_CATEGORIES: { name: string; account_type: string; sort_order: number }[] = [
  // Asset categories
  { name: "Bank", account_type: "Asset", sort_order: 1 },
  { name: "Accounts Receivable", account_type: "Asset", sort_order: 2 },
  { name: "Other Current Assets", account_type: "Asset", sort_order: 3 },
  { name: "Fixed Assets", account_type: "Asset", sort_order: 4 },
  { name: "Inventory", account_type: "Asset", sort_order: 5 },
  // Liability categories
  { name: "Accounts Payable", account_type: "Liability", sort_order: 6 },
  { name: "Credit Card", account_type: "Liability", sort_order: 7 },
  { name: "Other Current Liability", account_type: "Liability", sort_order: 8 },
  { name: "Long-term Liability", account_type: "Liability", sort_order: 9 },
  { name: "Payroll Liability", account_type: "Liability", sort_order: 10 },
  // Equity
  { name: "Owner's Equity", account_type: "Equity", sort_order: 11 },
  { name: "Retained Earnings", account_type: "Equity", sort_order: 12 },
  // Income
  { name: "Sales Revenue", account_type: "Income", sort_order: 13 },
  { name: "Service Revenue", account_type: "Income", sort_order: 14 },
  // COGS
  { name: "Cost of Materials", account_type: "Cost of Goods Sold", sort_order: 15 },
  // Expense
  { name: "Operating Expenses", account_type: "Expense", sort_order: 16 },
  { name: "Administrative Expenses", account_type: "Expense", sort_order: 17 },
  { name: "Payroll Expenses", account_type: "Expense", sort_order: 18 },
  // Other Income / Other Expense
  { name: "Other Income", account_type: "Other Income", sort_order: 19 },
  { name: "Other Expense", account_type: "Other Expense", sort_order: 20 },
];
...
const DEFAULT_ACCOUNTS: DefaultAccount[] = [
  ...
  { account_code: "1200", account_name: "Inventory Asset", account_type: "Asset", account_subtype: "Inventory", category_name: "Inventory" },
  { account_code: "1300", account_name: "Prepaid Expenses", account_type: "Asset", account_subtype: "Other Current Assets", category_name: "Other Current Assets" },
  { account_code: "1310", account_name: "Employee Advances", account_type: "Asset", account_subtype: "Other Current Assets", category_name: "Other Current Assets" },
  ...
  // Liabilities – Other Current (2100–2499)
  { account_code: "2100", account_name: "Salaries Payable", account_type: "Liability", account_subtype: "Payroll Liability", category_name: "Payroll Liability" },
  { account_code: "2110", account_name: "EPF Payable", account_type: "Liability", account_subtype: "Payroll Liability", category_name: "Payroll Liability" },
  { account_code: "2120", account_name: "ETF Payable", account_type: "Liability", account_subtype: "Payroll Liability", category_name: "Payroll Liability" },
  { account_code: "2200", account_name: "VAT Payable", account_type: "Liability", account_subtype: "Sales Tax Payable", category_name: "Other Current Liability" },
  { account_code: "2300", account_name: "Accrued Expenses", account_type: "Liability", account_subtype: "Other Current Liability", category_name: "Other Current Liability" },
  { account_code: "2400", account_name: "Short-term Loans", account_type: "Liability", account_subtype: "Other Current Liability", category_name: "Other Current Liability" },
  // Liabilities – Long-term (2500–2999)
  { account_code: "2500", account_name: "Long-term Loans", account_type: "Liability", account_subtype: "Long-term Liability", category_name: "Long-term Liability" },
  { account_code: "2510", account_name: "Mortgage Payable", account_type: "Liability", account_subtype: "Long-term Liability", category_name: "Long-term Liability" },
  { account_code: "2520", account_name: "Lease Liability", account_type: "Liability", account_subtype: "Long-term Liability", category_name: "Long-term Liability" },
  // Equity (3000–3999)
