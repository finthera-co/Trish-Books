...
export const MODULE_CONFIGS: Record<string, ModuleConfig> = {
  ...
  banking: {
    ...
    sidebarItems: [
      ...
      { label: "Bank Statement Import", path: "/banking/statement-import", icon: FileSpreadsheet },
      { label: "Suspense Clearing", path: "/banking/suspense-clearing", icon: HelpCircle },
      { label: "Import Rules", path: "/banking/import-rules", icon: Wand2 },
